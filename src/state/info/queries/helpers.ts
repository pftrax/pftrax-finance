...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, rimauDayDatas } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | rimauDayDatas): ChartEntry => ({
