...
import { Text, Button, Input, Flex, Grid, useMatchBreakpoints } from '@rimauswap-libs/uikit'
    ...
    <AutoColumn gap="md">
      <AutoColumn gap="sm">
        ...
        <Flex flexWrap={['wrap', 'wrap', 'nowrap']}>
          <Grid gridTemplateColumns="1fr 1fr 1fr" gridGap="16px" mb={['16px', '16px', 0]} mr={[0, 0, '16px']}>
            <Button
              style={{fontSize:14}}
              scale={isXs || isSm ? 'sm' : 'md'}
              onClick={() => {
                setSlippageInput('')
                setRawSlippage(10)
              }}
              variant={rawSlippage === 10 ? 'primary' : 'secondary'}
            >
              0.1%
            </Button>
            <Button
             ...
             scale={isXs || isSm ? 'sm' : 'md'}
              ...
              variant={rawSlippage === 50 ? 'primary' : 'secondary'}
            >
              0.5%
            </Button>
            <Button
             ...
             scale={isXs || isSm ? 'sm' : 'md'}
              ...
              variant={rawSlippage === 100 ? 'primary' : 'secondary'}
            >
              1%
            </Button>
          </Grid>
