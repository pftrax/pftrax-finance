...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@rimauswap-libs/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% RIMAU', { cost: getBalanceNumber(numberCakeToReactivate) })}
      </Text>
