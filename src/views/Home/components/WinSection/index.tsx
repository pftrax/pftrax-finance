...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@rimauswap-libs/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'RIMAU card' },
    { src: 'green', alt: 'Green RIMAU card with up arrow' },
    { src: 'red', alt: 'Red RIMAU card with down arrow' },
    { src: 'top-right', alt: 'RIMAU card' },
  ],
}
