...
import { Flex, Text, Skeleton, Link, Button, ArrowForwardIcon } from '@rimauswap-libs/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in RIMAU prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with RIMAU, win RIMAU if your numbers match')}
        </Text>
      </Flex>
