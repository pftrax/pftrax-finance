...
import { AutoRenewIcon, Button, Card, CardBody, Flex, Skeleton, Text, Link, ArrowForwardIcon } from '@rimauswap-libs/uikit'
...
const HarvestCard = () => {
  ...
  return (
    <StyledCard>
      <CardBody>
        <Flex flexDirection={['column', 'row', null, 'row']} justifyContent="space-between" alignItems="center">
