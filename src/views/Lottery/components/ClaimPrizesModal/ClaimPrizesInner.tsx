...
import { Flex, Button, Text, AutoRenewIcon, PresentWonIcon } from '@rimauswap-libs/uikit'
  ...
  const handleClaim = async () => {
    ...
    try {
      ...
      if (receipt.status) {
        toastSuccess(
          t('Prizes Collected!'),
          t('Your RIMAU prizes for round %lotteryId% have been sent to your wallet', { lotteryId }),
        )
        setPendingTx(false)
