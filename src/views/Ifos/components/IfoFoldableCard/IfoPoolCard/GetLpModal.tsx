...
import { Modal, ModalBody, Text, Image, Button, Link, OpenNewIcon } from '@rimauswap-libs/uikit'
    ...
    <Modal title={t('LP Tokens required')} onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        <Image
          ...
          mb="24px"
        />
        <Text mb="16px">{t('You’ll need RIMAU-BNB LP tokens to participate in the IFO!')}</Text>
        <Text mb="24px">{t('Get LP tokens, or make sure your tokens aren’t staked somewhere else.')}</Text>
        <Button
          as={Link}
          external
          href={`${BASE_ADD_LIQUIDITY_URL}/BNB/0x098dCbf3518856E45BB4e65E7fCc7C5Ff4a2C16e`}
