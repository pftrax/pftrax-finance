...
import { Heading, Button, Text } from '@rimauswap-libs/uikit'
  ...
  return (
    <>
      ...
      <Text color="textSubtle">
        {t('It looks like you’ve disabled your account by removing your Rimau Collectible (NFT) profile picture.')}
      </Text>
      <Text>
