...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from '@rimauswap-libs/uikit'
...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({ pool, stakingMax, isRemovingStake = false, onDismiss }) => {
  ...
  return (
    ...
    >
      ...
      />
      <Text mt="8px" ml="auto" color="textSubtle" fontSize="14px" mb="8px">
