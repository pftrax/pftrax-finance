...
import { Text, Flex, Box, Card } from '@rimauswap-libs/uikit'
        ...
        <Flex>
          ...
          <Box ml="16px">
            ...
            <Flex alignItems="center">
              <Text fontSize="14px" mr="6px" color="textSubtle" lineHeight="16px">
...
const TopTokenMovers: React.FC = () => {
  ...
  return (
    <Card style={{background:'transparent'}}  my="16px">
      {/* <Text ml="16px" mt="8px">
        {t('Top Movers')}
      </Text> */}
